...
public class QuestionDaoImpl implements QuestionDao {
	...
	public List<Catalog> getRows(Integer areaId, Integer subareaId) {
		  List<Catalog> pr =  jdbcTemplate.query("select * from RS_QUESTION where areaId = ? and subareaId = ? order by createdAt desc ",
	                new Object[] {areaId,  subareaId}, new BeanPropertyRowMapper<Catalog>(Catalog.class));
