...
public class PositionDaoImpl implements PositionDao {
	...
	public List<Catalog> getRows() {
		// TODO Auto-generated method stub
		  List<Catalog> pr =  jdbcTemplate.query("select * from RS_POSITION_CATALOG order by createdAt desc ",
	...
	public void removeRow(Integer id) {
		// TODO Auto-generated method stub
		final String sql = "UPDATE RS_POSITION_CATALOG SET status = ?  WHERE id = ? ";
	...
	public void addRow(Catalog p) {
		// TODO Auto-generated method stub
		final String sql = "INSERT INTO RS_POSITION_CATALOG (id, name, status, createdAt "+")  VALUES ( ?,?,?, ?)";
